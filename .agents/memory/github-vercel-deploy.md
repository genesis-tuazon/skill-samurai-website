...
## Flow
Replit edits → push to GitHub (automatic, done at end of every session) → Vercel auto-deploys (~1 min)
...
**How to apply:** ALWAYS push to GitHub at the end of every session after making changes. No need to wait for the user to ask. GITHUB_PERSONAL_ACCESS_TOKEN secret is stored in Replit.
