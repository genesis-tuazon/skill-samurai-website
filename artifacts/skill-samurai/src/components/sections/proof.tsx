        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          <FadeIn direction="up" delay={0.2}>
            <div className="group rounded-[3rem] overflow-hidden relative aspect-video bg-secondary border-[8px] border-white shadow-2xl shadow-black/10 hover:-translate-y-2 hover:-rotate-1 transition-all duration-500 mt-0 md:mt-12">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-secondary via-secondary/40 to-transparent pointer-events-none" />
              <div className="absolute bottom-0 left-0 w-full p-8 md:p-10 translate-y-4 group-hover:translate-y-0 transition-transform">
                <div className="inline-block px-4 py-2 bg-primary text-white text-sm font-black uppercase tracking-wider rounded-full mb-4 shadow-lg -rotate-2 group-hover:rotate-0 transition-transform">Scratch / Python</div>
                <h4 className="text-3xl font-black font-heading mb-3 text-white">Arcade Classics</h4>
                <p className="text-white/90 font-medium line-clamp-2 text-lg">Rebuilding classic arcade mechanics from the ground up, learning variables, loops, and collision detection.</p>
              </div>
            </div>
          </FadeIn>
        </div>
