...
const features = [
  ...
  "Year-round at our Winnipeg location",
];
    ...
    <section id="weekly-classes" className="py-20 md:py-28 bg-muted/30 relative overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        <FadeIn delay={0.2} className="mt-12 max-w-xl mx-auto text-center">
          ...
          <div className="inline-flex flex-col items-center bg-white border border-border rounded-2xl shadow-md px-5 py-4 mb-6">
            <p className="text-xs font-bold uppercase tracking-[0.2em] text-primary mb-1">Seven Oaks</p>
