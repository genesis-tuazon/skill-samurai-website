          ...
          <div>
            <FadeIn direction="right">
              ...
              <p className="mt-5 sm:mt-6 text-lg sm:text-xl text-secondary/80 font-medium max-w-xl leading-relaxed">
                We meet your child exactly where they&apos;re at. No experience needed — just a structured, fun environment where screen time becomes learning that builds real skills they&apos;ll use everywhere.
              </p>
            </FadeIn>
