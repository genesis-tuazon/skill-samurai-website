...
import { X, MapPin, CalendarCheck } from "lucide-react";
...
const locations = [
  {
    ...
    days: "Mon – Tue",
    href: "https://book.skillsamuraiwinnipeg.com/widget/booking/yJGhJxF00WXEIK4PMqwR",
  },
  {
    name: "Seven Oaks",
...
export function MakeupModal() {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label="Book a Makeup Class"
    >
      <div
      ...
      <div className="relative z-10 w-full max-w-sm rounded-3xl bg-white shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="px-6 py-6 flex flex-col gap-4">
          <p className="text-sm text-muted-foreground leading-relaxed">
            Choose the location where your child attends. We'll find you an available makeup spot.
          </p>
