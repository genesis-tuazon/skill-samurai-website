...
const stats = [
  { value: "159", label: "Five-Star Google Reviews" },
            ...
            {[
              {
                ...
                detail: "159 five-star Google reviews from real Winnipeg families. That's not a marketing claim — it's what parents say after their kids have actually been through our classes.",
              },
              {
        ...
        <div className="container mx-auto px-4 max-w-3xl text-center">
          <FadeIn>
            ...
            <h2 className="text-3xl md:text-4xl font-black font-heading text-secondary leading-tight tracking-tight mb-5">
              159 five-star reviews from Winnipeg families.
            </h2>
